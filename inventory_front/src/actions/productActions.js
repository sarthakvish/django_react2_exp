...
export const deleteProduct = (id) => async (dispatch, getState) => {
    try{
        ...
        const {data}=await axios.delete(`http://localhost:3000/api/products/delete/${id}`,
            config)
...
export const createProduct = () => async (dispatch, getState) => {
    try{
        ...
        const {data}=await axios.post(`http://localhost:3000/api/products/create/`,
            {},
            config)
...
export const updateProduct = (product) => async (dispatch, getState) => {
    try{
        ...
        const {data}=await axios.put(`http://localhost:3000/api/products/update/${product._id}/`,
            product,
            config)
...
export const createProductReview = (productId,review) => async (dispatch, getState) => {
    try{
        ...
        const {data}=await axios.post(`http://localhost:3000/api/products/${productId}/reviews/`,
            review,
            config)
