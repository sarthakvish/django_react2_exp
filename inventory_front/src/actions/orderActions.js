...
export const createOrder = (order) => async (dispatch, getState) => {
    try{
        ...
        const {data}=await axios.post(`http://localhost:3000/api/orders/add/`,
            order,
            config)
...
export const payOrder = (id, paymentResult) => async (dispatch, getState) => {
    try{
        ...
        const {data}=await axios.put(`http://localhost:3000/api/orders/${id}/pay/`,
            paymentResult,
            config)
...
export const deliverOrder = (order) => async (dispatch, getState) => {
    try{
        ...
        const {data}=await axios.put(`http://localhost:3000/api/orders/${order._id}/deliver/`,
            {},
            config)
